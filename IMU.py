...
def initIMU():
    ...
    if (LSM9DS0):   #For BerryIMUv1
        ...
        writeGRY(LSM9DS1_CTRL_REG1_G,0b10101000)    #Gyro ODR = 476Hz, 500 dps
        ...
        writeACC(LSM9DS1_CTRL_REG6_XL,0b01100000)   #+/- 2g

        #initialise the magnetometer
        writeMAG(LSM9DS1_CTRL_REG1_M, 0b11011110)   #Temp compensation enabled, High-performance mode mode, 80Hz Fast ODR
        writeMAG(LSM9DS1_CTRL_REG2_M, 0b00000000)   #+/-4gauss
        writeMAG(LSM9DS1_CTRL_REG3_M, 0b00000000)   #continuos update
        writeMAG(LSM9DS1_CTRL_REG4_M, 0b00001000)   #High-performance mode for Z axis
